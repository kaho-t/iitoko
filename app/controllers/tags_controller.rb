class TagsController < ApplicationController
  ...
  def tag_params
    params.require(:tag).permit(:sea, :mountain, :river, :field, :hotspring, :north, :south,
                                :easy_to_go, :small_city, :car, :train,
                                :low_price, :moving_support, :entrepreneur_support,
                                :child_care_support, :job_change_support, :park, :education,
                                :food, :architecture, :history, :event, :tourism)
  end
