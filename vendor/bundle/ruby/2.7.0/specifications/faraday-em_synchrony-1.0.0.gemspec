...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<em-synchrony>.freeze, [">= 1.0.3"])
    s.add_development_dependency(%q<faraday>.freeze, ["~> 1.0"])
    s.add_development_dependency(%q<faraday-em_http>.freeze, ["~> 1.0"])
    ...
    s.add_dependency(%q<em-synchrony>.freeze, [">= 1.0.3"])
